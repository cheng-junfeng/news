...
import com.news.ui.image.ImagePickerDetailActivity;
import com.news.ui.image.ImagePickerListActivity;
import com.news.ui.qrcode.camera.CameraManager;
import com.news.ui.qrcode.decode.DecodeThread;
import com.news.ui.qrcode.decode.DecodeUtils;
import com.news.ui.qrcode.utils.BeepManager;
import com.news.ui.qrcode.utils.InactivityTimer;
    ...
    protected void initViews() {
        ...
        capturePictureBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                readyGoForResult(ImagePickerListActivity.class, IMAGE_PICKER_REQUEST_CODE);
            }
        });
...
//            initCamera(holder);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == IMAGE_PICKER_REQUEST_CODE) {
            String imagePath = data.getStringExtra(ImagePickerDetailActivity
