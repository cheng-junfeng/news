...
import com.library.pla.PLAAbsListView;
import com.library.pla.PLAMultiColumnListView;
import com.library.progress.CircularProgressBar;
import com.news.R;
...
public class PLALoadMoreListView extends PLAMultiColumnListView implements PLAAbsListView.OnScrollListener {
    ...
    private void init(Context context) {
        ...
        // footer
        mFooterView = (RelativeLayout) mInflater.inflate(R.layout.item_common_load_more_footer, this, false);
        mLabLoadMore = mFooterView.findViewById(R.id.common_load_more_footer_msg);
        mProgressBarLoadMore = mFooterView.findViewById(R.id.common_load_more_footer_progress);
