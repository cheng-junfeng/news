...
import com.hint.model.Circle;


public class OneFishView extends View {
    ...
    public OneFishView(Context context) {
        this(context, null);
    }

    public OneFishView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public OneFishView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
