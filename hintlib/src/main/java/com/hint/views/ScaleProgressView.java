...
import com.hint.R;
import com.hint.utils.DensityUtils;
...
public class ScaleProgressView extends View {
    ...
    public ScaleProgressView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.ScaleProgressView, defStyleAttr, 0);
        mProgressColor = typedArray.getColor(R.styleable.ScaleProgressView_progressColor, Color.BLUE);
        mBaseColor = typedArray.getColor(R.styleable.ScaleProgressView_baseColor, Color.GRAY);
        mTextColor = typedArray.getColor(R.styleable.ScaleProgressView_textColor, Color.RED);
        mDotColor = typedArray.getColor(R.styleable.ScaleProgressView_dotColor, Color.GREEN);
        mTextSize = (int) typedArray.getDimension(R.styleable.ScaleProgressView_textSize, DensityUtils.dp2px(context, 16));
        typedArray.recycle();
