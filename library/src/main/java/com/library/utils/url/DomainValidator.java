...
//        "tp",                 // East Timor (Retired)
    ...
    /*
     * This field is used to detect whether the getContext has been called.
     ...
     * using the getContext methods which are all (now) synchronised.
     */
    // WARNING: this array MUST be sorted, otherwise it cannot be searched reliably using binary search
     ...
     * This must only be done at program startup, before any instances are accessed using getContext.
     * <p>
     * For example:
     * <p>
     ...
     * @throws IllegalStateException if the method is called after getContext
    ...
    public static synchronized void updateTLDOverride(ArrayType table, String [] tlds) {
        if (inUse) {
            throw new IllegalStateException("Can only invoke this method before calling getContext");
        }
